...
This document describes how @sebastienrousseau/r-config is run: who decides what, how
...
@sebastienrousseau/r-config is **maintainer-led**. As of the current release line it has a single
