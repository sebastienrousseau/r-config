# `@sebastienrousseau/r-config` Examples Catalog

This directory provides runnable, standalone examples covering **100% of the functionalities and features** provided by `@sebastienrousseau/r-config`.
...
- [x] **.lintr**: Standardized rule preset
