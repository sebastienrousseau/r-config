...
%global npm_bare      r-config
%global sitelib       %{_prefix}/lib/node_modules

Name:           nodejs-sebastienrousseau-r-config
Version:        0.0.7
Release:        1%{?dist}
Summary:        Shareable R configuration providing standardized lintr and styler rules adhering to modern 2026 standards

License:        Apache-2.0 OR MIT
URL:            https://github.com/sebastienrousseau/r-config
Source0:        %{name}-%{version}.tar.gz
BuildArch:      noarch
Requires:       nodejs >= 20

%description
@sebastienrousseau/r-config is a shareable configuration preset with no runtime
...
install -pm 0644 .lintr %{buildroot}%{sitelib}/%{npm_scope}/%{npm_bare}/
